...
import { faBarChart, faBell, faBook, faBookmark, faCartShopping, faCompass, faFile, faFileAlt, faGlobe, faTag, faMailBulk, faMailReply, faMessage, faNetworkWired, faPhone, faPhotoFilm, faPieChart, faQuestionCircle, faSuitcase, faPeopleLine, faClock, faExclamationTriangle } from '@fortawesome/free-solid-svg-icons';
...
export const Sidebar=()=>{
  ...
  const toggle = (index) => {
    ...
    const sideItem1 = [
        {title:"Home",icon:<FontAwesomeIcon icon={faPieChart} />, 
        drop:[
        ...
        {title:"Ecommerce",icon:<FontAwesomeIcon icon={faCartShopping} />,
      drop:[
        {title:"Admin"},
        {title:"SuperAdmin"},
      ]
    ...
    const sideItem2=[
      {title: "Starter", path: "/starter", icon:<FontAwesomeIcon icon={faCompass} />},
      {title: "Faq", path: "/faq", icon:<FontAwesomeIcon icon={faQuestionCircle} />},
      {title: "Landing", path: "/landing", icon:<FontAwesomeIcon icon={faGlobe} />},
      {title: "Pricing", path: "/pricing", icon:<FontAwesomeIcon icon={faTag} />},
      {title: "Notification", path: "/notification", icon:<FontAwesomeIcon icon={faBell} />},
      {title: "Members", path: "/members", icon:<FontAwesomeIcon icon={faPeopleLine} />},
      {title: "Timeline", path: "/timeline", icon:<FontAwesomeIcon icon={faClock} />},
      {title: "Errors", path: "/errors", icon:<FontAwesomeIcon icon={faExclamationTriangle} />},
      {title: "Authentication", icon:<FontAwesomeIcon icon={faPieChart} />,
      drop:[
        {title:"Login", path:"/login"},
